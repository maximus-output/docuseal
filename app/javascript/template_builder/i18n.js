const en = {
  ...
  pay_before_submit: 'Pay before submit',
  invoice_after_signing: 'Invoice after signing',
...
const es = {
  ...
  pay_before_submit: 'Pagar antes de enviar',
  invoice_after_signing: 'Factura tras firmar',
  payment_terms: 'Condiciones de pago',
  due_on_receipt: 'Al recibir',
  net_x_days: 'Neto X días',
...
const it = {
  ...
  pay_before_submit: 'Paga prima di inviare',
  invoice_after_signing: 'Fattura dopo la firma',
  payment_terms: 'Condizioni di pagamento',
  due_on_receipt: 'Alla ricezione',
  net_x_days: 'Netto X giorni',
...
const pt = {
  ...
  pay_before_submit: 'Pagar antes de enviar',
  invoice_after_signing: 'Fatura após assinatura',
  payment_terms: 'Condições de pagamento',
  due_on_receipt: 'A pagar na receção',
  net_x_days: 'Líquido X dias',
  days_until_due: 'Dias até ao vencimento',
  editable: 'Editável',
...
const fr = {
  ...
  pay_before_submit: 'Payer avant de soumettre',
  invoice_after_signing: 'Facture après signature',
  payment_terms: 'Conditions de paiement',
  due_on_receipt: 'À réception',
  net_x_days: 'Net X jours',
  days_until_due: "Jours jusqu'à l'échéance",
...
const de = {
  ...
  pay_before_submit: 'Vor dem Senden bezahlen',
  invoice_after_signing: 'Rechnung nach der Unterzeichnung',
  payment_terms: 'Zahlungsbedingungen',
  due_on_receipt: 'Bei Erhalt fällig',
  net_x_days: 'Netto X Tage',
...
const nl = {
  ...
  pay_before_submit: 'Betalen voor verzending',
  invoice_after_signing: 'Factuur na ondertekening',
  payment_terms: 'Betalingsvoorwaarden',
  due_on_receipt: 'Betaalbaar bij ontvangst',
  net_x_days: 'Netto X dagen',
